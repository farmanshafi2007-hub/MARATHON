...
export default function App() {
    ...
    const handleSetAutoPaused = (val: boolean) => {
        autoPausedRef.current = val;
        setAutoPaused(val);
    };
    ...
    const togglePause = () => {
        ...
        if (!isPaused) {
            ...
            setIsPaused(false);
            handleSetAutoPaused(false);
            runDataRef.current.lastTick = Date.now();
        }
    };
    ...
    // --- SHARED STATS CARD GENERATION (SHARE CARD) ---
    const generateShareCard = async (photoFile?: File) => {
        ...
        ctx.fillText(`ATHLETE: ${userData?.name?.toUpperCase() || 'FARMAN SHAFI'}  |  STREAK: ${userData?.streak || 24}`, 540, 930);
            ...
            <div id="home-view" className="absolute inset-0 px-5 pt-6 overflow-y-auto custom-scroll w-full h-full pb-20">
                ...
                <div id="home-total-distance-card" className="mb-6 p-6 bg-gradient-to-br from-[#34c759] to-[#00a86b] text-white rounded-[2rem] shadow-xl relative overflow-hidden">
                    <div className="relative z-10 flex flex-col justify-between h-full">
                        <div>
                            <span className="text-[10px] font-bold text-white/70 uppercase tracking-widest">DISTANCE</span>
        ...
        return (
            <div id="run-tab-view" className="absolute inset-0 px-5 pt-6 overflow-y-auto custom-scroll w-full h-full pb-32">
                ...
                <div className="p-6 skeuo-element text-center mb-6">
                    <p className="text-[10px] font-bold tracking-widest text-[#34c759] uppercase">TARGET</p>
    ...
    const ProgressView = () => {
        ...
        const achievementsList = [
            ...
            { name: "Streak", color: "from-purple-400 to-indigo-600", unlocked: totalStreakVal >= 5 }
        ];
            ...
            <div id="more-view" className="absolute inset-0 px-5 pt-6 overflow-y-auto custom-scroll w-full h-full pb-32">
                ...
                <div id="more-profile-card" className="p-6 skeuo-element flex items-center gap-4 mb-6 relative overflow-hidden">
                    ...
                    <div className="flex-1">
                        ...
                        <span className="inline-block bg-green-50 text-[#34c759] border border-green-100 text-[8px] font-bold px-2 py-0.5 rounded-full mt-1.5 uppercase">Account</span>
                    </div>
                </div>
    ...
    const Run = () => {
        ...
        return (
            <div id="active-workout-view" className="absolute inset-0 z-[61] bg-[#000000] text-white flex flex-col justify-between w-full h-full pb-8 overflow-hidden">
